...
Si el efectivo ingresado supera el ticket, el POS destaca inmediatamente el excedente y exige elegir entre **Dar vuelto** o **Dejar saldo a favor**. Dar vuelto muestra el importe a entregar y registra en caja solamente el efectivo retenido. Dejar saldo a favor requiere seleccionar un cliente; registra todo lo recibido, aplica al ticket solo su total y conserva el excedente para una compra futura. Para Consumidor Final solo se permite dar vuelto. Los importes de tarjeta, transferencia u otros medios nunca pueden originar vuelto.
