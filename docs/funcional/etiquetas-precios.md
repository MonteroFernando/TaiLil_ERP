...
El modulo **Ventas → Etiquetas de precios** permite buscar articulos con el buscador general, indicar la cantidad de copias y preparar una impresion en medidas fisicas exactas.

Formatos disponibles, expresados como alto por ancho:
...
El mismo selector del POS permite usar **Vista previa** o **Impresion directa**. La seleccion queda guardada en el navegador. Cuando el puesto se abre mediante `Abrir-TaiLilERP-POS.ps1`, el boton **Imprimir directo** envia las etiquetas a la impresora predeterminada sin mostrar el dialogo. En impresoras de rollo con cortador, el corte por pagina o etiqueta debe habilitarse en el driver oficial.
