...
const opciones=[
 ...
 {grupo:"Compras",nombre:"Compras",detalle:"Ingresos y facturas de proveedores",href:"/compras",icono:"CO"},
 ...
 {grupo:"Ventas",nombre:"Etiquetas de precios",detalle:"Diseño e impresion por tamaño",href:"/ventas/etiquetas",icono:"ET"},
] as const;
export default function NavegacionPrincipal({children}:{children:React.ReactNode}){
 ...
 const menu=administrador?[...opciones,{grupo:"Ventas",nombre:"Configuracion POS",detalle:"Puntos de venta y cajas",href:"/ventas/configuracion-pos",icono:"PC"} as const,{grupo:"Administracion",nombre:"Accesos",detalle:"Usuarios y permisos",href:"/configuracion/accesos",icono:"⚙"} as const]:opciones;
