...
export const SECCIONES_MANUAL: SeccionManual[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      "Copie la letra, el POI o punto de emisión y el número impresos en la factura del proveedor.",
    ...
    consejos: ["La factura se verá como letra + POI + número; el identificador interno nunca se usa para buscarla.", "El costo de compra es interno y no se muestra en el POS.", "La sugerencia MRP usa ventas de días en los que el artículo tuvo stock."],
  ...
  },
  {
    ...
    pasos: [
      ...
      "Si el efectivo supera el total, elija Dar vuelto o Dejar saldo a favor; esta última opción requiere un cliente seleccionado.",
      "Si corresponde, active Impresión directa para imprimir y enviar el corte automáticamente.",
    ],
    consejos: ["Al recorrer resultados con las flechas, la lista acompaña la opción resaltada; Enter la confirma y Escape cierra el selector.", "F2 vuelve al campo de producto, F3 consulta precios y F10 abre el cobro.", "La cuenta corriente debe elegirse expresamente; un medio faltante impide confirmar.", "Solo el efectivo puede generar vuelto. Si se deja el excedente a favor, el cobro completo queda disponible para futuras compras del cliente."],
  ...
  },
  {
    ...
    resumen: "Administra deudas, límites, anticipos, cobros, pagos y aplicaciones entre documentos.",
    paraQueSirve: "Muestra la posición agrupada de las cuentas visibles, cuánto crédito fue asignado y ocupado, quién tiene saldo a favor y cómo se relaciona cada cobro o pago con sus facturas.",
    ...
    pasos: [
      ...
      "Busque o filtre en el listado general y revise la posición agrupada; los totales corresponden solamente a las cuentas visibles.",
      "Compare límite asignado, crédito ocupado, porcentaje utilizado, disponible y saldo a favor; luego pulse Abrir cuenta.",
      "Revise deuda, saldo a favor y documentos pendientes en el modal.",
      "En clientes pulse el número completo del ticket para abrir sus artículos, cantidades, precios, impuestos y totales.",
      "En proveedores identifique cada factura por su letra, POI y número, nunca por un código interno.",
      "Registre el cobro o pago e indique cuánto aplicar a cada documento.",
      "Use Historial y conciliación para revisar aplicaciones anteriores o completar una imputación parcial.",
      "En Caja y arqueo use Retirar dinero y elija Gasto directo o Pago a proveedor; nunca deje la salida sin clasificar.",
      "Si eligió Pago a proveedor sin factura, abra luego su cuenta y concilie el pago disponible.",
      "En Caja y arqueo declare valores y cierre el período operativo.",
    ],
    consejos: ["Los tickets se muestran como letra + punto de venta + número; nunca como identificadores internos.", "Un pago puede aplicarse a varias facturas y una factura a varios pagos; una aplicación parcial también puede completarse después.", "Un pago a proveedor descuenta la caja una sola vez y puede quedar como anticipo sin aplicar.", "Si el saldo pendiente es cero, no existe importe para imputar.", "El disponible final de una venta puede ser menor porque el POS también controla período y vencimiento."],
    palabrasClave: ["tesorería", "cuenta corriente", "deuda", "límite asignado", "crédito ocupado", "porcentaje utilizado", "saldo a favor", "conciliar", "cobro", "pago", "retiro", "gasto", "cierre"],
  },
  {
    id: "informes", orden: 10, modulo: "Informes", titulo: "Informes, ventas y márgenes", icono: "10",
    resumen: "Consulta flujo de dinero trazable, comprobantes, costos, margen monetario y porcentaje.",
    paraQueSirve: "Permite recorrer cada movimiento desde la caja y el usuario hasta el socio y los comprobantes relacionados.",
    ...
    pasos: [
      ...
      "En Flujo de dinero pulse Ver trazabilidad para identificar usuario, caja y comprobantes relacionados.",
    ...
    consejos: ["Un pago sin facturas relacionadas todavía está disponible para conciliar en la cuenta del proveedor.", "El precio de compra no se muestra en consultas comerciales; solo se utiliza internamente para el margen.", "El porcentaje de margen se calcula sobre el importe neto del comprobante."],
    palabrasClave: ["informe", "flujo dinero", "trazabilidad", "mapa", "gasto", "pago proveedor", "ventas", "margen", "rentabilidad", "Excel", "costo"],
  },
  {
